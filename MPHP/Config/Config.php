...
return array(
	...
	'LANGUAGE'=>'zh',//语言包
	'DIR_SAFE'=>true,//是否创建安全文件
    'AUTO_LOAD_FILE'=>array(),//自动加载文件应用Lib目录或者Common/Lib
	/********************************URL设置********************************/
    ...
    /********************************图像水印处理********************************/
    'WATER_ON'                      => TRUE,        //开关
    'WATER_FONT'                    => MPHP_PATH . 'Data/Font/font.ttf',   //水印字体
    'WATER_IMG'                     => MPHP_PATH . 'Data/Image/water.png', //水印图像
    ...
    /********************************验证码********************************/
    'CODE_FONT'                     => MPHP_PATH . 'Data/Font/font.ttf', //字体
