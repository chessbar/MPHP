...
final class Route
{
    ...
    static private function setConst()
    {
        ...
        //框架目录相关URL
        defined('__MPHP__') or define("__MPHP__", __HOST__ . '/' . trim(str_ireplace(str_replace('\\', '/', $_SERVER['DOCUMENT_ROOT']), "", MPHP_PATH), '/'));
        defined('__MPHP_DATA__') or define("__MPHP_DATA__", __MPHP__ . '/Data');
        defined('__MPHP_EXTEND__') or define("__MPHP_EXTEND__", __MPHP__ . '/Extend');
        //应用
